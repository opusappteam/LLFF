...
//             $menu['utils']['content']['report']['page'] = 'http://192.168.35.12/Reports/Pages/Folder.aspx?ItemPath=%2fTestSSRS&ViewMode=List';
        ...
        foreach ($menu as $part => $data) {
            if (isset($data['content']) && count($data['content'])) {
                ...
                if ($part == 'utils') {
                    //http://192.168.33.48/Reports/Pages/Folder.aspx?ItemPath=%2fLenovoServiceCenterReport_Release2&ViewMode=List
					echo '<li><a href="http://192.168.33.48/Reports/Pages/Folder.aspx?ItemPath=%2fLenovoServiceCenterReport_Release2&ViewMode=List" target="_blank">Lenovo Reports</a></li>';
                }
